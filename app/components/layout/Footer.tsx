...
export const Footer: React.FC<FooterProps> = ({
  sections = [
    {
      title: 'Services',
      links: [
        { label: 'Residential Rentals', href: '/services/residential' },
        { label: 'Commercial Rentals', href: '/services/commercial' },
        { label: 'Construction Sites', href: '/services/construction' },
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Waste Guidelines', href: '/guidelines' },
  ...
  description = 'Your trusted partner for affordable and reliable dumpster rental services. Serving residential, commercial, and construction projects.',
  copyrightText,
}) => {
